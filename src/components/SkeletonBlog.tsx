...
interface ISkeletonBlogProps {
    descriptionActive: boolean
}


export default function SkeletonBlog({ descriptionActive }: ISkeletonBlogProps) {
    return (
        <div className='post'>
            <div className='post__skeleton-img'></div>
            <div className='post__bottom'>
                <div className='post__top'>
                    <div className='post__skeleton-header'></div>
                    <div className='post__rating'>
                        <div className='post__rate-container'>
                            <svg className='post__like' width="28" height="25" viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`post__description ${descriptionActive ? "" : "hidden"}`}>
                    <p className='post__description-skeleton'>
                        
                    </p>
                    <p className='post__description-skeleton second'>
                        
                    </p>

                </div>
                <div className='post__btn'>
                    <div className='post__view'>Читать далее</div>
                </div>
            </div>
        </div>
    )
